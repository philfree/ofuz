...
/**COPYRIGHTS**/
    ...
    if (isset($plugin_item_value)){
        ...
        $do_auto_responder_email->getId($plugin_item_value);
    ...
    ?> 
        ...
        <div class="banner50 pad020 text16 fuscia_text">
          <?php 
			  ...
			  echo _('Auto Responder '). '<a href="'.$cfg_plugin_mkt_path.'AutoResponderEmail/'.$_SESSION['do_auto_responder_detail']->idautoresponder.'">'.$_SESSION['do_auto_responder_detail']->name.'</a>'. _(' - email template edit '). $_SESSION['do_auto_responder_email']->subject ; 
		...
		<select name="email_template" onchange="getEmailTemplateText(this)">
         ...
         <?php
              ...
              $_SESSION['do_auto_responder_email']->form->goto = $cfg_plugin_mkt_path.'AutoResponderEmail/'.$_SESSION['do_auto_responder_detail']->idautoresponder;
              ...
              echo $do_auto_responder_email->form->getFormFooter(_('Update'));
               echo '&nbsp;&nbsp;<a href="'.$cfg_plugin_mkt_path.'AutoResponderEmailEdit/'.$idautoresponder.'"><input type="button" value="'._('Cancel').'"></a>';
              echo '</div>';
         ?>
        </div>
