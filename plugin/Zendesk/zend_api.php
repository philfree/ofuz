<?php
	...
	<table border=0 width="75%">
		<tr>
			<td><b>Zend Email</b> </td> <td><b>Zend API</b> </td> <td><b>Zend URL</b></td><td><b>Unlink</b></td>
		</tr>
	<?php
	...
	for($i=0;$i <= max(array_map('count', $data)) - 1; $i++){
		  ...
		  echo"<tr><td>".$data['zend_email'][$i]."</td><td>".$data['zend_api'][$i]."</td><td>".$data['zend_url'][$i]."</td><td>".$u_link."</td></tr>";
