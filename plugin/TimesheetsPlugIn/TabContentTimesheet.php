...
<a href="/Tab/TimesheetsPlugIn/TabContentTimesheet/1234"> Check out the second page of this Sample Plug in</a>
<br/>
<br/>
<br/>
Here is an other example of plug in page: <a href="/PlugIn/TimesheetsPlugIn/TimesheetsPage">/PlugIn/TimesheetsPlugIn/TimesheetsPage</a> its a simple page thats do not need a TAB its usefull if you need to link a Block to a simple page. 
