 ...
 * Current setting sends following webhook-attributes:
   cardId,listId,oldListId,boardId,commentId,card,board,comment,user,swimlaneId
   To add/remove, we can set it. 
...
// To test Request Body data and write into a file
/*
