...
// Copyright 2001 - 2007 SQLFusion LLC           info@sqlfusion.com
  ...
  // Database connexions :
if ( $_ENV['GISH_MODE'] == 'docker') {
  $conx = new sqlConnect('root', $_ENV["DB_ENV_MYSQL_ROOT_PASSWORD"]);
  $conx->setHostname($_ENV['DB_PORT_3306_TCP_ADDR']);
  $conx->setDatabase($_ENV["DB_ENV_MYSQL_DATABASE"]);
