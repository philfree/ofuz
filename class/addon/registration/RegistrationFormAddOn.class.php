...
class RegistrationFormAddOn extends RegistrationAddOnBase {
   
    public $name = "Registration Form";
    public $name_toolbar = "Reg Form";
    protected $description = "Registration form for new users and user editing";
    protected $group = "Samples"; // name of the group this add on is part of
    protected $default_layer_name = "RegistrationForm";
    ...
    public function formProperty() {
        ...
        $form = "Form to register on your site.";
        $form .="<br><b>Next Page:</b><br/>".$formfields->thankyou_page;
        $form .="<hr></hr>";
    ...
    public function insertInPage(Array $params) {   
        ...
        $content .= "\n      \$_SESSION['do_".$params['User_Class']."']->formRegister('".$params['thankyou_page']."',
