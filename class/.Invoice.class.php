  ...
  /*  function eventFilterInvoiceByStatus(EventControler $evtcl){
    ...
    */
    ...
    /**
      ...
      * @param $iduser -- INT
      * @return $num -- INT // This could be changed to a character padding as well by minor changes
    */
...
//echo $idinvoice.":".$idcontact;exit();
    ...
    */
    ...
    /**
      ...
      * @param $due -- FLOAT
      * @return $Authnet_form -- STRING
    */
    function prepareAuthnetForm($due){
        $Authnet_form = '<table>';
	...
	*/
	  ...
	  * @return $html_data -- STRING
        */
         ...
         * @param strin of the status current status as in db
	...
	/**
	  ...
	  * @param int $idcontact contact primarykey id
