 ...
 * @package PASClass
 */
Class DijitExpandingTextArea extends RegistryFieldBase {
    function default_Form($field_value="") {
        include_once("includes/dojo.dijit.expandingtextarea.js.inc.php");
        if (!$this->getRData('hidden') && !$this->getRData('readonly')) {
            ...
            $fval .= '<textarea class="'.$field_class.'" name="fields['.$this->field_name.']"
